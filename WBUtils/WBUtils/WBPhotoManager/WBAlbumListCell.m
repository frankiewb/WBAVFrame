...
@implementation WBAlbumListCell

+ (instancetype)cellWithTableView:(UITableView *)tableView {
    WBAlbumListCell *cell = [tableView dequeueReusableCellWithIdentifier:kAlbumCellReuserIdentifier];
    
    if (!cell) {
        cell = [[WBAlbumListCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:kAlbumCellReuserIdentifier];
...
#pragma mark - Setter
- (void)setAlbumModel:(WBAlbumModel *)albumModel {
